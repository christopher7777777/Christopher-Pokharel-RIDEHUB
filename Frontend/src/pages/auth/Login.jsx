                ...
                <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-0 shadow-2xl rounded-[40px] overflow-hidden bg-white border border-gray-100">
                    ...
                    <div className="bg-white p-6 md:p-12 flex flex-col justify-center">
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-xl md:text-2xl font-bold text-slate-800 uppercase tracking-tight mb-1">Welcome Back</h2>
                            <p className="text-[10px] md:text-sm text-slate-500 font-semibold uppercase tracking-wider opacity-60 italic">Sign in to continue your journey</p>
                        </div>

                        {error && (
                            <div className="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-2xl mb-6 text-[10px] md:text-sm font-bold uppercase tracking-wider text-center shadow-sm animate-pulse">
                                {error}
                            </div>
                        )}
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-5 py-3 md:py-3.5 bg-slate-50 border ${error && error.toLowerCase().includes('email') ? 'border-red-500' : 'border-slate-100'} rounded-2xl text-slate-900 font-semibold placeholder-slate-300 focus:outline-none focus:ring-4 focus:ring-orange-500/10 focus:border-orange-500 transition-all text-sm`}
