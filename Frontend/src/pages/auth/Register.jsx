    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col pt-16 md:pt-20">
            ...
            <div className="flex-grow flex items-center justify-center p-4 relative overflow-hidden">
                ...
                <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-0 shadow-2xl rounded-[40px] overflow-hidden bg-white border border-gray-100 my-8">
                    ...
                    <div className="bg-white p-6 md:p-12 flex flex-col justify-center">
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-xl md:text-2xl font-bold text-slate-800 uppercase tracking-tight mb-1">Welcome</h2>
                            <p className="text-[10px] md:text-sm text-slate-500 font-semibold uppercase tracking-wider opacity-60 italic">Create an account to get started</p>
                        </div>

                        {error && (
                            <div className="bg-red-50 border border-red-100 text-red-600 px-4 py-3 rounded-xl mb-6 text-[10px] md:text-xs font-semibold uppercase tracking-widest text-center shadow-sm">
                                {error}
                            </div>
                        )}
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            <div>
                                <label className="block text-slate-700 text-[10px] md:text-[11px] font-semibold uppercase tracking-widest mb-2 ml-1">
                                    Full Name
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    value={formData.role}
                                    onChange={handleChange}
                                    className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-2xl text-slate-900 font-semibold uppercase tracking-widest focus:outline-none focus:ring-4 focus:ring-orange-500/10 focus:border-orange-500 transition-all text-[10px] md:text-[11px] appearance-none cursor-pointer"
                                >
                            ...
                            <div className="text-center pt-2">
                                <p className="text-[10px] md:text-[11px] font-semibold text-slate-400 uppercase tracking-widest">
